...
class LocID(StrIntEnum):
    ...
    # Remaining locations of enemies
    GATOS_EXHIBIT = 0x6
    MEDINA_SQUARE = 0x1F
    MEDINA_ELDERS_HOUSE_1F = 0x21
    MEDINA_ELDERS_HOUSE_2F = 0x22
    MEDINA_INN = 0x23
    MEDINA_PORTAL = 0x24
    MEDINA_MARKET = 0x27
    ...
    DENADORO_MOUNTAIN_VISTA = 0x94
    DENADORO_GAUNTLET = 0x96
    CASTLE_MAGUS_ENTRANCE = 0xA6
    CASTLE_MAGUS_LOWER_BATTLEMENTS = 0xB0
    OZZIES_FORT_HALL_OF_DISREGARD = 0xB2
    MANORIA_KITCHEN = 0xCA
    GUARDIA_FOREST_FROG_KING_BATTLE = 0xCC
    ARRIS_DOME_RAFTERS = 0xDD
    FACTORY_RUINS_ENTRANCE = 0xE4
    FACTORY_RUINS_INFESTATION = 0xE8
    SEWER_ACCESS_B2 = 0xED
    ...
    ENHASA_BELTHASARS_PRIVATE_STUDY = 0x169
    BLACKBIRD_HANGER = 0x16F
    ...
    OCEAN_PALACE_TBD = 0x1A0
    LAST_VILLAGE_COMMONS = 0x1A8
    TYRANO_LAIR_MAIN_CELL = 0x1AE
    BLACKBIRD_ARMORY_1 = 0x1BC
    CASTLE_MAGUS_UPPER_BATTLEMENTS = 0x1BE
    CASTLE_MAGUS_GRAND_STAIRWAY = 0x1BF
